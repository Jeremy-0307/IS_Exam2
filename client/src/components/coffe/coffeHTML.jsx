		...
		<div className='container'>
		  <div className='modal-body col'>
		    ...
		    <div className='row justify-content-center'>
			 ...
			 <div className='modal-footer row position-static'>
				<div className='row text-center justify-content-between' >
		      <button className='btn btn-lg btn-secondary m-1 col-2' data-bs-dismiss='modal' onClick={() => props.setModalCoffe({component: <></> })}>
		        Cancel
		      </button>
		      <button className='btn btn-lg btn-danger m-1 col-2'  data-bs-dismiss='modal' onClick={() => updateBill(currAmout, props)}>
		        Confirm
		      </button>
		    </div>
		  </div>
